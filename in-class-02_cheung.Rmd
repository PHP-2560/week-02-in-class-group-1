...
```
The names() command renamed the variable names with more meaning.
...
rain.df <- cbind(rain.df, daily)

hist(rain.df$daily)

```
There are negative numbers in the histogram.
